...
import com.ly.entity.ColumnEntity;
import com.ly.entity.TableEntity;
import com.ly.entity.mongo.MongoGeneratorEntity;
...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("template/Business.java.vm");
        templates.add("template/BusinessImpl.java.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.ly" : mainPath;
        //封装模板数据
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("MongoChildrenEntity.java.vm")) {
            return packagePath + "dao" + File.separator + "entity" + File.separator + "inner" + File.separator + currentTableName + File.separator + splitInnerName(className) + "InnerEntity.java";
        }
        ...
        if (template.contains("Mapper.java.vm")) {
            return packagePath + "dao" + File.separator + "mappers" + File.separator + className + "Mapper.java";
        }

        if (template.contains("Business.java.vm")) {
            return packagePath + "business" + File.separator + className + "Business.java";
        }

        if (template.contains("BusinessImpl.java.vm")) {
            return packagePath + "business" + File.separator + "impl" + File.separator + className + "BusinessImpl.java";
        }
        ...
        if (template.contains("Mapper.xml.vm")) {
            return "main" + File.separator + "resources" + File.separator + "mappers" + File.separator + moduleName + File.separator + className + "Mapper.xml";
        }
